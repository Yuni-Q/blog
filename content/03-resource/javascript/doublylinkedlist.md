...
- [codingeverybody/data_structure_java](https://github.com/codingeverybody/data_structure_java/blob/master/java/src/list/doublylinkedlist/implementation/DoublyLinkedList.java)
