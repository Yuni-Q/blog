...
- `Typescript` `React` `Next.js` `pnpm`
- 배달의민족 B마트, 배민스토어 웹뷰 작업
- 23.08 ~
...
- `Typescript` `React` `Next.js` `Nest` `vanilla-extract` `module-federation` `pnpm`
...
- `Typescript` `Nest` `TypeORM` `postgreSQL` `nest mono repo` `NEXT` ``
...
- 임의 이미지 최적화에 사용할 수 있는 옵티마이저 개발을 통해 이미지 리소스 관리 최적화
  - width, height, format, quality, object-fit
- 측정된 기술지표를 통해 프로덕트 현황 공유 및 대응방안 마련을 위한 템플릿 구조 확립
- 사내 디자인시스템 적용
  - 아틀리에 블루
...
- `Typescript` `Nest` `TypeORM` `postgreSQL` `nest mono repo`
...
- 회사 배포 시스템인 심플로이 v6 도입
  ...
  - docker 관련 세팅
  - gitlab ci 관련 세팅
- 프론트엔드 개발자들이 업무에 집중할 수 있도록 필요한 기능들을 개발함.
- SRE, 클라우드플랫폼, 클라우드스토리지, 보안팀과 협업하여 개발 환경 구성
  - 지라, 위키, 깃랩, 슬랙 등 다양한 툴을 권한 문제를 관련 팀과 논의
- 지라, 위키, 노션, 깃랩, 슬랙 등 다양한 툴을 사용할 수 있는 환경 구성.
- 데브옵스 유지 보수성 및 성능 향상을 위해 아키텍처 개선에 참여함.
- 지라, 위키, 노션, 깃랩, 슬랙 등 다양한 툴의 통합 검색 기능을 구현.
...
- 깃랩의 MR을 슬랙으로 전송하기 위한 작업들.
- 슬랙에 기존에 있는 앱을 통하지 않고 슬랙 워크플로우로 지라 티켓 만들기.
...
- 슬랙 워크플로우를 통해 기존에 사용하던 워크플로우에 더 많은 기능을 제공
...
- 운영 환경의 지라, 위키를 테스트하기 위한 STAGE, BETA 환경 구축
...
- 디자인 QA 리딩
- TF 지원
- 커머스백오피스플랫폼을 개발하면서 시스템의 기준을 마련함.
- 디자인 QA를 하면서 오는 혼선을 통합 관리함.
...
- 결제플랫폼 2.0 개발
  - 결제플랫폼 2.0 개발을 통해 코드에 대한 이해와 나아갈 방향을 제시함.
...
- 배민페이 관리지면을 개편하여 유지보수성을 향상 시키고 고객에게 좋은 UI/UX를 제공
