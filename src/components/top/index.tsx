...
const StyledButton = styled.button`
	...
	&:hover { 
		.theme1 {
			...
			&::after {
				border-radius: 50%;
				box-shadow: 0 -23px 0 #fff, 0 23px 0 #fff, 23px 0 0 #fff,
					-23px 0 0 #fff, 15px 15px 0 #fff, -15px 15px 0 #fff,
					15px -15px 0 #fff, -15px -15px 0 #fff;
			}
		}
		.snow {
			fill: ${({ snow }) =>
	...
	return (
		<div className="top">
			...
			<StyledButton theme={theme} snow={state.snow} onClick={() => {
				...
				<StyledSvg className="snow" snow={state.snow} version="1.1" id="레이어_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 23.9 22.9">
					<path d="M23.9,10c0-0.3-0.2-0.5-0.4-0.6l-1.1-0.3C22.1,9.1,22,9,21.9,8.8c-0.1-0.2,0-0.4,0.1-0.6l0.8-0.9
